...
For this part of the assignment, please continue working on the dataset you chose for part 1 of the group assignment, which can still be found [here](https://anastasiaGiachanou.github.io/adav-course/files/datasets-assignment-1stGA.zip). A brief outline is repeated below. Each of these datasets has a large number of variables, and it is up to you which variables you will use/not use within your visualization and analysis process. Note that if you would like to adjust the variables you use in the final assignment compared to part 1, you can do so.
...
All datasets can be downloaded from [here](https://anastasiaGiachanou.github.io/adav-course/files/datasets-assignment-1stGA.zip), a brief description of each can be found below:
