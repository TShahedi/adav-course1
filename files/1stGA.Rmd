...
The assignment is to be worked on in threes or fours, for which you will receive the group division from your lab instructor. For this assignment, you will use one of the six datasets which can be found [here](https://anastasiaGiachanou.github.io/adav-course/files/datasets-assignment-1stGA.zip), each of which are outlined in brief below. Each of these datasets has a large number of variables, and it is up to you which variables you will use/not use within your visualization and analysis process. Below you will find a step-by-step walkthrough for the assignment.
